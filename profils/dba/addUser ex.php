...
$users = getUsers();
$pavillons = getAllPavillons_2($connexion);
...
<body>
                ...
                <center>
                    ...
                    <div class="row tab-full">
                        ...
                        <div class="col-4 var" style="display: none;">
                          ...
                          <div class="col-4 fac" style="display: none;">
                            <label for="fac" class="form-label">FAC :</label>
                            <input type="text" name="fac" class="form-control full-width"
                                value="<?= $userToEdit ? htmlspecialchars($userToEdit['fac']) : ''; ?>" />
                        </div>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const varFac = document.querySelector(".fac");
        ...
        const togglePavillonVisibility = () => {
            ...
            if (profileSelect.value === "pcs") {
                varFac.style.display = "block"; // Afficher si paiement
            } else {
                varFac.style.display = "none";
            }
        };
