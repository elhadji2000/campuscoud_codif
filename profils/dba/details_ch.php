...
$lits = getLitParChambre_2($link, $numch);
?>
...
<body>
    ...
    <section id="styles" class="s-styles">
        <center>
            ...
            <div class="table-responsive container-fluid" style="margin-top:20px;font-size:11px; width:100%;text-align:center;">
                <table border="1" class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= htmlspecialchars($lit['statut']??"vide"); ?></td>
