...
<body>
    ...
    <div class="container container2">
        <strong><a href="add_delai" class="text-decoration-underline">Delai pédagogique</a></strong>
        <strong><a href="add_delai_social" class="text-decoration-underline" >Delai sociale</a></strong>
    </div>
    </div>
