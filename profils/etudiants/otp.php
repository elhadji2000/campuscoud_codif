        ...
        <div class="card">
                ...
                <form action="confirm-otp.php" method="POST">
                    ...
                    <div class="otp-group">
                        ...
                        <div class="otp-input-wrapper">
                            <input type="text" name="otp" maxlength="6" placeholder="• • • • • •" inputmode="numeric"
            ...
            <div class="card-footer">
                <small>
                    ...
                    <a href="renvoyer_otp.php" class="fw-bold text-decoration-none"
                        onclick="return confirm('Souhaitez-vous recevoir un nouveau code OTP ?');">
