    ...
    <div class="container-fluid" style="font-size:16px;">
        <center>
            ...
            <h2>Faculter : <?= htmlspecialchars($fac) ?> | <a href="trait_choix?fac=<?= htmlspecialchars($fac) ?>"
                    class="text-danger text-decoration-underline" onclick="return confirm('Etes vous sur de vouloir continuer?')">Codifier les Suppleants</a></h2>
        </center>
