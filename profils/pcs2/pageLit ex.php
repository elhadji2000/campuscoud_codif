...
<body>
    ...
    function rechercher(type) {
        ...
        fetch("rechercher_etudiant?num=" + numero)
            ...
            .then(data => {
                ...
                if (data.etat_inscription !== "Inscrit(e)") {
                    zone.innerHTML = `
                        <div class='alert alert-danger'>
                            Cet étudiant est non inscrit ${data.nom} !<br>.
                        </div>
                    `;
                    return;
                }
                if (data.payant !== "Régime Non Payant" ) {
                    zone.innerHTML = `
                        <div class='alert alert-danger'>
                            Cet étudiant est regime payant !<br>.
                        </div>
                    `;
                    return;
                }
               /*  if (data.annee !== "2028" ) {
                    zone.innerHTML = `
                        <div class='alert alert-danger'>
                            Cet étudiant n'est pas inscrit(e) a l'annee academique choisit !<br>.
                        </div>
                    `;
                    return;
                }
