    ...
    function rechercher(type) {
        ...
        fetch("rechercher_etudiant.php?num=" + numero)
            ...
            .then(data => {
                ...
                const anneeSession = "<?= $anneeSession ?>";
                if (data.annee !== anneeSession) {
                    zone.innerHTML = `
                        <div class='alert alert-danger'>
                            l'etudiant ${data.prenom} ${data.nom} n'est pas Inscrit(e) a l'annee ${anneeSession} ${data.annee}!<br>.
                        </div>
                    `;
                    if (type === "titulaire") {
                        titulaireValide = false;
            ...
            `;
                if (type === "titulaire") {
                    ...
                    document.getElementById("btnAttribuer").disabled = false;
                }
