                ...
                <div class="<?= $individuel ? 'col-md-12' : 'col-md-6' ?>">
                    <div class="p-3 border rounded bg-light">
                        ...
                        <div class="p-3 bg-white border rounded">
                            ...
                            <h3>NiveauFormation : <?= htmlspecialchars($occupants[0]['NiveauFormation']) ?></h3></br>
                ...
                <div class="col-md-6">
                    <div class="p-3 border rounded bg-light">
                        ...
                        <div class="p-3 bg-white border rounded">
                            ...
                            <h3>NiveauFormation : <?= htmlspecialchars($occupants[1]['NiveauFormation']) ?></h3></br>
    ...
    function rechercher(type) {
        ...
        fetch("rechercher_etudiant.php?num=" + numero)
            ...
            .then(data => {
                ...
                const anneeSession = "<?= $annee ?>"; // ex: 2024_2025
                const anneeEtudiant = data.annee; // ex: 2022_2023

                // extraire les années de fin
                const anneeFinEtudiant = parseInt(anneeEtudiant.slice(-4));
                const anneeFinSession = parseInt(anneeSession.slice(-4));

                // condition >= 2
                if ((anneeFinSession - anneeFinEtudiant) >= 2) {
                    zone.innerHTML = `
                    <div class='alert alert-danger'>
                        l'etudiant ${data.prenom} ${data.nom} est ancien (année invalide ≥ 2 ans)<br>
                        Année étudiant: ${anneeEtudiant} | Session: ${anneeSession}
                    </div>
                `;
