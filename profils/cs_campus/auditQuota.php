        ...
        <table class="table table-bordered" style="font-size: 16px;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td rowspan="<?= $rowspanPavillon ?>" style="vertical-align: middle; text-align: center;">
                        <?= $pavillon ?></td>
                    <?php $firstPavillon = false; ?>
                    <?php endif; ?>
                    <?php if ($firstChambre): ?>
                    <td rowspan="<?= $rowspanChambre ?>" style="vertical-align: middle; text-align: center;">
                        <?= $chambre ?></td>
                    ...
                    <td style="text-align: center;">
                        ...
                        <?php } else { ?>
                        <a class="btn btn-dark btn-sm" data-toggle="modal" data-target="#exampleModal1"
                            style="pointer-events: none; color: gray; cursor: not-allowed; text-decoration: none;">
                            <i class="fa fa-trash"></i> Supprimer
                        </a>
                        <?php } ?>
                    </td>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="requestAuditQuota.php?id_lit_q=<?= $info_lit['id_lit_q'] ?>"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <?php
            $quotaSaisi = quota_saisie($connexion, $_SESSION['classe'], $_SESSION['sexe_agent']);
            $quotaPrevu = quota_prevu($connexion, $_SESSION['classe'], $_SESSION['sexe_agent']);
        ?>
        ...
        <form action="requestAuditQuota.php" method="post">
            ...
            <?php if ($quotaSaisi == $quotaPrevu) { ?>
            <!-- Si quota OK : Bouton valide -->
            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal">
                VALIDER
            </button>
            <?php } else { ?>
            <!-- Si quota incorrect : Bouton avec alerte -->
            <button type="button" class="btn btn-warning"
                onclick="showQuotaAlert(<?= $quotaPrevu ?>, <?= $quotaSaisi ?>)">
                VALIDER
            </button>
            <?php } ?>
...
<script>
function showQuotaAlert(quotaPrevu, quotaSaisi) {
    alert(
        "! Validation impossible :\n" +
        "- Quota prévu : " + quotaPrevu + "\n" +
        "- Quota saisi : " + quotaSaisi + "\n\n" +
        "Veuillez compléter correctement le quota avant de valider."
    );
}
</script>
