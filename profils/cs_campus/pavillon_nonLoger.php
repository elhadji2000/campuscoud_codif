...
$data = getTitulaireByPavillon_nonLoger($pavillon, $connexion);
...
<tbody>
                ...
                <tr style="font-family:Times;font-size:15px;">
                    ...
                    <td><?= htmlspecialchars($lits[0]['telephone']) ?></td>   <?php  $statut=info_statu($lits[0]['num_etu']);    ?>
                    
                    
                      <?php  if($statut=='Attributaire') {   ?>
                     <td> <font color='red' ><?= htmlspecialchars($statut) ?></font></td>
                     <?php } else {  ?>
                ...
                <tr style="font-family:Times;font-size:15px;">
                    ...
                    <td><?= htmlspecialchars($lit['titulaire_nom']) ?></td> <?php $tel=getTelephoneEtudiant($lit['num_etu']);   $statut=info_statu($lit['num_etu']);  ?>
