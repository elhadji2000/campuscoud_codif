                    ...
                    <form id="loginForm" method="POST" action="traitement/connect">
                        ...
                        <fieldset>
                            <div class="form-field">
                                <input onkeydown="upperCaseF(this)" name="username_user" id="username" required
                                    type="text" placeholder="Numero de carte (ou du certificat d'inscription)" value=""
                                    class="full-width">
                            </div>
                            <div class="form-field">
                                <input name="password_user" type="password" required id="password"
                                    placeholder="Mot de passe" value="" class="full-width">
                            </div>
                            <div class="form-field">
