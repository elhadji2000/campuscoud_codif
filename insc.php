        ...
        <div class="row contact__main">
            <div class="col-eight tab-full contact__form1">
                <form name="contactForm" id="contactForm" method="post" action="insc2">
                     ...
                     *                     <script langage='javascript'>
                     *                     alert(
                     *                         'Suite à des soucis liés aux envois de mails, la creation de compte a été suspendue. Veuillez reessayer dans quelques minutes!')
                     *                     </script>
                     *                     <?php
                     * 				 echo '<meta http-equiv="refresh" content="0;URL=index">';
                     *                      exit();
                    ...
                    <body>
                        <form action="insc2" method="post">
                            ...
                            <tr>
                                <td colspan="4">
                                    <center>
                                        <strong>VEUILLEZ RENSEIGNER VOS INFORMATIONS PERSONNELLES <br>(Numero Carte,
                                            Date de naissance, NIN)</strong>
                                    </center>
                                </td>
                            </tr>
                            ...
                            <fieldset>
                                ...
                                <div class="form-field">
                                    <input onkeydown="upperCaseF(this)" name="num_etu" required type="text"
                                        onkeydown='return sansEspace();' id="num_etu"
                                        placeholder="Numero de carte (ou du certificat d'inscription)" value=""
                                        class="full-width">
                                </div>
                                <div class="form-field">
                                    <input name="dateNaissance" required type="text" onkeydown='return sansEspace();'
                                        id="dateNaissance" placeholder="Date de Naissance (JJ/MM/AAAA)"
                                        aria-required="true" class="full-width">
                                </div>
                                <div class="form-field">
                                    <input name="numIdentite" required type="text" onkeydown='return sansEspace();'
                                        id="numIdentite" placeholder="Numero C.N.I (13 chiffres, sans espace)" value=""
                                        class="full-width">
                                </div>
